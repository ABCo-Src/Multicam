...
namespace ABCo.Multicam.Server.Features.Switchers.Core.ATEM.Native
{
    ...
    public class WindowsNativeATEMSwitcher : INativeATEMSwitcher, IBMDSwitcherCallback
    {
        ...
        public INativeATEMBlockIterator CreateMixBlockIterator()
        {
            ...
            _comSwitcher.CreateIterator(typeof(IBMDSwitcherMixEffectBlockIterator).GUID, out nint iterBase);
        ...
        {
            // Get iterator as IUnknown
            _comSwitcher.CreateIterator(typeof(IBMDSwitcherInputIterator).GUID, out nint iterBase);
