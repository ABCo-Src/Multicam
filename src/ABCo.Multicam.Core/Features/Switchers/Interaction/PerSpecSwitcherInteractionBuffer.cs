...
{
    public interface IPerSpecSwitcherInteractionBuffer : INeedsInitialization<SwitcherSpecs, ISwitcher, ISwitcherEventHandler>, ISwitcherEventHandler
    {
    ...
    public class PerSpecSwitcherInteractionBuffer : IPerSpecSwitcherInteractionBuffer
    {
        ...
        public PerSpecSwitcherInteractionBuffer(ISwitcherInteractionBufferFactory factory)
        {
            _factory = factory;
        }
        
        public void FinishConstruction(SwitcherSpecs specs, ISwitcher switcher, ISwitcherEventHandler bufferParentEventHandler)
        {
            Specs = specs;
            _rawSwitcher = switcher;
            _eventHandler = bufferParentEventHandler;
            ...
            if (switcher.IsConnected)
            {
                ...
                {
                    _mixBlockBuffers[i] = _factory.CreateMixBlock(Specs.MixBlocks[i], i, switcher, bufferParentEventHandler);
    ...
    {
        IMixBlockInteractionBuffer CreateMixBlock(SwitcherMixBlock mixBlock, int mixBlockIdx, ISwitcher switcher, ISwitcherEventHandler eventHandler);
    ...
    public class SwitcherInteractionBufferFactory : ISwitcherInteractionBufferFactory
    {
        ...
        public IMixBlockInteractionBuffer CreateMixBlock(SwitcherMixBlock mixBlock, int mixBlockIdx, ISwitcher switcher, ISwitcherEventHandler eventHandler) =>
            new MixBlockInteractionBuffer(mixBlock, mixBlockIdx, switcher, eventHandler, this);
