...
//            Mock<IPerSwitcherInteractionBuffer> Buffer,
//            Mock<IHotSwappableSwitcherInteractionBuffer> DynamicBuffer,
...
//            _mocks.ServSource.Setup(m => m.Get<IHotSwappableSwitcherInteractionBuffer>(It.IsAny<ISwitcherEventHandler>())).Returns(_mocks.DynamicBuffer.Object);
//        }
...
//            _mocks.ServSource.Verify(m => m.Get<IPerSwitcherInteractionBuffer, ISwitcherEventHandler>(feature), Times.Once);
...
//        {
//            Create().GetProgram(3);
//            _mocks.DynamicBuffer.VerifyGet(m => m.CurrentSpecBuffer);
...
//        {
//            var feature = Create();
//            feature.UpdateProg(new SwitcherProgramChangeInfo());
...
//        {
//            var feature = Create();
//            feature.UpdatePreview(new SwitcherPreviewChangeInfo());
//            _mocks.UIBinder.Verify(m => m.ModelChange_BusValues());
//        }
...
//		{
//			var feature = Create();
//			feature.OnConnectionStateChange(false);
//			_mocks.UIBinder.Verify(m => m.ModelChange_ConnectionState());
//		}
